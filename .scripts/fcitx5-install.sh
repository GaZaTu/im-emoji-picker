...
ln -s $(realpath $__DIRNAME/../fcitx5-inputmethod.conf) /usr/share/fcitx5/inputmethod/fcitx5imemojipicker.conf

mkdir -m 755 -p /usr/lib/fcitx5
ln -s $(realpath $__DIRNAME/../build/im-emoji-picker-fcitx5.so) /usr/lib/fcitx5/fcitx5imemojipicker.so
